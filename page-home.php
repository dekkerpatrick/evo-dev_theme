...
$course_url             = get_post_meta( 7, 'course-url', true );
...
<section id="boost-income">
    <div class="container">
        ...
        <p class="head">Whether you’re a freelance designer, entrepreneur, employee for a company, code hobbyist, or looking for a new career — this course gives you an immensely valuable skill that will enable you to either:</p>
        <div class="row">
            <div class="col-sm-6">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                <p>You got to work with a modern, professional quality design &amp; layout.</p>
            </div><!-- col -->
            <div class="col-sm-4">
                <img src="<?php bloginfo('stylesheet_directory');?>/assets/img/icon-code.png" alt="Code">
                <h3>Quality HTML &amp; CSS3</h3>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8 offset-sm-2">
                ...
                <iframe width="100%" height="415" src="https://www.youtube.com/embed/4KvXrbabutg" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
            </div><!-- col -->
        </div><!-- row -->
    </div><!-- container -->
</section><!-- featurette -->
            ...
            <div class="col-sm-8">
                ...
                <div class="row testimonial">
                        <div class="col-sm-4">
                            ...
                            <img src="<?php bloginfo('stylesheet_directory');?>/assets/img/ernest.png" alt="Illustration of a man with a black jacket">
